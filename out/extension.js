...
//         const success = await executeCommandAndUpdateResults(command);
...
//           const success = await executeCommandAndUpdateResults(testCommand);
...
// async function executeCommandAndUpdateResults(command: string): Promise<boolean> {
...
// function updateTestResultsFromOutput(command: string, success: boolean): void {
//   const match = command.match(/([^\s]+\.php)/);
//   if (match) {
...
//     }
//     const fileResults = testResults.get(filePath)!;
//     fileResults.set("All Tests", success);
//   }
// }
